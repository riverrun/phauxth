defmodule Phauxth.TestAccounts do
  ...
  @users [
    %{id: 1, email: "fred+1@mail.com", username: "fred", phone: "55555555555",
      role: "user", password_hash: Comeonin.Bcrypt.hashpwsalt("h4rd2gU3$$"),
      confirmed_at: nil, confirmation_token: @key, confirmation_sent_at: Ecto.DateTime.utc},
    %{id: 2, email: "ray@mail.com", role: "user",
      password_hash: Comeonin.Bcrypt.hashpwsalt("h4rd2gU3$$"), confirmed_at: Ecto.DateTime.utc},
    %{id: 3, email: "froderick@mail.com", role: "user", confirmed_at: Ecto.DateTime.utc,
      password_hash: Comeonin.Bcrypt.hashpwsalt("h4rd2gU3$$"),
